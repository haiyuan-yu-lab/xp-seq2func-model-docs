...
This site documents release **0.1.0a4**.

## What ships in 0.1.0a4
...
!!! warning "Alpha release"
    **0.1.0a4** is a pre-release. Config schemas and CLI flags may change. Pin
    the tag if you need a fixed cut.

## Where to start

1. [Install](install.md) from the `v0.1.0a4` code tag
